...
**Hiring software uses a similar search and ranking technique as Google.** [This video explains it really well](https://youtu.be/BNHR6IQJGZs). Google checks each webpage for how relevant it is for certain keywords are and returns a prioritized list of websites every time you search. 
