...
Have you heard of Google? Do you know how it works? [Watch this video!](https://youtu.be/BNHR6IQJGZs). Google checks each webpage for how relevant the keywords are and returns a prioritized list of websites every time you search. *SEO (Search Engine Optimization)* refers to the playbook of techniques that websites use to rank higher on Google.

Hiring software works very similarly to Google except instead of websites, hiring software tackles resumes. If a website doesn't rank well on Google, people will rarely find it. If your resume doesn't rank well on a hiring manager's search keywords, *they will never see your resume or ask you to interview.*
...
To get a job interview, your resume needs to rank high within hiring software so a manager can find you.

**This post will focus on resume SEO for hiring software. Next week's post will tackle the persuasion of hiring managers.**

Understand the Process
---

To get an interview, your resume needs to impress a hiring manager. To get to the hiring manager, you have to get through the hiring software. Buy what is hiring software?
...
The industry is made up of different companies each with their own secret sauce for ranking but that all primarily rely keyword analysis (which is what our resume SEO will focus on). Here's how it all works [[1](https://i.kinja-img.com/gawker-media/image/upload/s--seFcpj4P--/c_fit,fl_progressive,q_80,w_636/18ix902ttt5hwpng.png)]:
...
> Next week...how to write your resume as a persuasive argument.
