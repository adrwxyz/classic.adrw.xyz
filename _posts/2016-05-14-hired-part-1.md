---
title:  "Hired: 6 Questions to Cut Resume Fluff"
...
seo-title: "Hired: 6 Questions to Cut Resume Fluff"
---
...
- **Is there a percentage change you could use to quantify your impact?** 
  ...
  - *Caution*: Percentages can be used to try and hide insignificant change behind a large percentage. Recruiters can see through this so don't try to make insignificant changes sound like impact.
...
- **Is there a static number that could be used?** 
  ...
  - *Caution*: raw numbers can be confidential data (ie. user acquisition, web visitors, revenue growth...) so check with your employer before using them. 
  - Examples
    - Grew Webplio beta to 264 teams
    - Resolved 2,148 support tickets for user base of 1.2 million
    - Improved support efficiency by writing 68 new canned responses
...
- **Are these the technologies or skills I could most strategically highlight given your next desired job?**
...
> Newsflash: your resume needs SEO just as much as a website

**Next week, I'll show you how to target the keywords that will help get your resume in front of hiring managers.**
